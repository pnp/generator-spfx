...
generators.forEach(item => {
    ...
    if (fs.existsSync(requestPath)) {
        ...
        const targetPath = path.join(requestPath,
            'lib/generators/applicationCustomizer/templates/none')
        if (
...
const appCustomizer = basePath[0];

console.log('appCustomizer:::::', basePath)
console.log('appCustomizer:::::', appCustomizer)
