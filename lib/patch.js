...
console.log('Prcess Environment :::', process.env.npm_execpath);
...
const appCustomizer = getInstallPath('lib/generators/applicationCustomizer/templates/none');
const commandSet = getInstallPath('/lib/generators/commandSet/templates/none');
...
console.log('🚚🚚🚚', reactFolderAppCustomizer);
