...
module.exports = {
    ...
    projectStatusCheck(projectFolder) {
        ...
        console.log('__dir after', __dirname);
        ...
        projectUpgrade.commandAction(
            cmdInstance,
            upgradeSettings,
            (err) => {
                cmdInstance12.error(err);
            });
        ...
        if(log.length === 0){
            ...
            console.log(`The project check found ${log.length} steps to upgrade your project to `, upgradeSettings.options.toVersion);
            return false;
