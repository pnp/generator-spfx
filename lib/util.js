...
module.exports = {
    ...
    writeTemplates(yeoman) {
        ...
        console.log('SCOPE', path.dirname(require.main.filename));
        ...
        if (fs.existsSync(yorcPath)) {
            ...
            let environment = yoConfig[spfxNS].environment,
                ...
                templatePath = spfxTempFolder + componentType + '-' + environment + '/';

            // console.log('file exists', fs.existsSync(spfxConfigPath));
            // console.log('file exists', spfxConfigPath);

            let spfxConfigContent = 
                fs.readFileSync(spfxConfigPath, 'utf-8')

            spfxConfig = JSON.parse(spfxConfigContent);
