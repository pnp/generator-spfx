...
const projectUpgrade = (projectFolder, format) => {
    ...
    console.log(projectFolder, format);
    ...
    // console.log(upgradeCheckResult);
...
module.exports = {
    ...
    projectStatusCheck(yeoman, projectFolder, generatorVersion) {
        ...
        console.log('LOG   :', checkResult.log);
        ...
        // if (_log.length !== undefined && _log.length === 0) {

        //     console.log('Seems like you are good to go: ', _err);
        //     return true;

        // } else {

        //     console.log(`\n\n✋ The project check found ${_log.length} steps to upgrade your project to ️️${upgradeSettings.options.toVersion} ✋\n\n`);
        //     return false;
